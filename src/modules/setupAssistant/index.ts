...
export const SETUP_QUESTIONS: { key: string; section: SectionKey; prompt: string }[] = [
  ...
  { key: "campaign_start", section: "profile", prompt: "Campaign start date (YYYY-MM-DD)?" },
  { key: "campaign_length", section: "profile", prompt: "Campaign length in days?" },
  ...
  { key: "target_specialties", section: "audience", prompt: "Which specialties should targeting query (comma-separated)?" },
  { key: "diagnosis_codes", section: "audience", prompt: "Which diagnosis codes (ICD-10, comma-separated) define the target indications?" },
