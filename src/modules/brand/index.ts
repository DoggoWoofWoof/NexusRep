...
export const MILVEXIAN_PROFILE: BrandProfile = {
  ...
  approvedAnswers: [
    ...
    // ── Expanded public-fact knowledge base. Sourced from BMS/J&J press releases,
    // ClinicalTrials.gov, and peer-reviewed trial-design papers (Am Heart J / J Thromb Haemost).
    // Every entry is investigational-framed and non-promotional: publicly-disclosed program facts
    // only — NO efficacy/safety/dosing CLAIMS (trial regimens are stated as "under study, not a
    // recommended dose"). In production each would carry its own MLR sign-off; in the demo they
    // inherit the active MLR like the seeded six. This is what gives the rep breadth + depth.
    {
      id: "ans_moa_detail",
      topic: "mechanism detail",
      text: "Factor XIa (FXIa) acts in the contact (intrinsic) arm of the coagulation cascade, amplifying thrombin generation. Milvexian is being studied as a selective, oral FXIa inhibitor intended to reduce pathological clot formation (thrombosis) while seeking to preserve normal hemostasis. This hemostasis-sparing rationale defines the investigational FXIa-inhibitor class; its efficacy and safety remain under investigation and are not established.",
      detailAidSlideId: "slide_moa",
      slideTitle: "Mechanism of action",
      slideLabel: "Mechanism",
    },
    {
      id: "ans_class",
      topic: "drug class",
      text: "Factor XIa inhibitors are an investigational class of oral anticoagulants designed to interrupt the feedback loop that drives thrombin generation and clot growth. Milvexian is one investigational FXIa inhibitor. No FXIa inhibitor is FDA approved for these uses.",
      detailAidSlideId: "slide_moa",
      slideTitle: "Mechanism of action",
      slideLabel: "Mechanism",
    },
    {
      id: "ans_program_scale",
      topic: "program scale",
      text: "The Phase 3 LIBREXIA program is described as the most comprehensive Factor XIa clinical development program to date, enrolling roughly 50,000 participants across three event-driven trials — LIBREXIA STROKE, LIBREXIA ACS, and LIBREXIA AF. It is being conducted by Johnson & Johnson in collaboration with Bristol Myers Squibb.",
      detailAidSlideId: "slide_program",
      slideTitle: "LIBREXIA Phase 3 program",
      slideLabel: "LIBREXIA program",
    },
    {
      id: "ans_librexia_af",
      topic: "LIBREXIA AF atrial fibrillation trial",
      text: "LIBREXIA AF is a Phase 3 randomized, double-blind, active-controlled trial evaluating milvexian against apixaban in approximately 15,500 participants with atrial fibrillation or atrial flutter. The milvexian regimen studied is 100 mg twice daily. The trial is ongoing, with topline data anticipated in 2026. Comparative efficacy or safety conclusions are not available and cannot be drawn.",
      detailAidSlideId: "slide_af",
      slideTitle: "LIBREXIA-AF",
      slideLabel: "LIBREXIA-AF",
    },
    {
      id: "ans_librexia_acs",
      topic: "LIBREXIA ACS acute coronary syndrome trial",
      text: "LIBREXIA ACS was a Phase 3 randomized, double-blind, placebo-controlled trial of milvexian 25 mg twice daily added to standard antiplatelet therapy after a recent acute coronary syndrome, targeting about 16,000 participants. In November 2025 the sponsors discontinued the trial following a pre-planned interim analysis indicating it was unlikely to meet its primary efficacy endpoint; no new safety concerns were identified.",
      detailAidSlideId: "slide_acs",
      slideTitle: "LIBREXIA-ACS",
      slideLabel: "LIBREXIA-ACS",
    },
    {
      id: "ans_librexia_stroke",
      topic: "LIBREXIA STROKE ischemic stroke secondary prevention trial",
      text: "LIBREXIA STROKE is a Phase 3 trial studying milvexian 25 mg twice daily for secondary prevention after an acute ischemic stroke or high-risk transient ischemic attack (TIA). It is ongoing, with topline data anticipated in 2026.",
      detailAidSlideId: "slide_stroke",
      slideTitle: "LIBREXIA-STROKE",
      slideLabel: "LIBREXIA-STROKE",
    },
    {
      id: "ans_indications_studied",
      topic: "indications under study",
      text: "The indications under study in the LIBREXIA program are secondary prevention after acute ischemic stroke or high-risk TIA, recent acute coronary syndrome, and stroke prevention in atrial fibrillation. Milvexian is investigational and not approved for any indication.",
      detailAidSlideId: "slide_program",
      slideTitle: "LIBREXIA Phase 3 program",
      slideLabel: "LIBREXIA program",
    },
    {
      id: "ans_dosing",
      topic: "dosing under study",
      text: "Milvexian is investigational and has no FDA-approved dose. The regimens being studied are oral and twice daily: 25 mg twice daily in LIBREXIA STROKE (and in the discontinued LIBREXIA ACS trial) and 100 mg twice daily in LIBREXIA AF. These are investigational trial regimens, not a recommended dose.",
      detailAidSlideId: "slide_status",
      slideTitle: "Development status",
      slideLabel: "Development status",
    },
    {
      ...
      text: "Milvexian received U.S. FDA Fast Track designation for all three indications evaluated in the LIBREXIA program — secondary ischemic stroke prevention, acute coronary syndrome, and atrial fibrillation. Fast Track can support more frequent FDA interaction and eligibility for expedited review; it is not an approval, and milvexian remains investigational.",
      detailAidSlideId: "slide_status",
      slideTitle: "Development status",
      slideLabel: "Development status",
    },
    {
      id: "ans_sponsor",
      topic: "sponsor and collaboration",
      text: "Milvexian is being developed by Johnson & Johnson (Janssen) in collaboration with Bristol Myers Squibb.",
      detailAidSlideId: "slide_title",
      slideTitle: "Milvexian",
      slideLabel: "Title",
    },
  ...
  tryQuestions: [
    ...
    "Tell me about the LIBREXIA-AF trial",
    "What happened with the LIBREXIA ACS trial?",
